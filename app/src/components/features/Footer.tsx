...
const Footer: FC = () => {
    return (
        <footer id="footer" className="bg-gradient-to-b from-black via-black/80 to-[#7a0000] text-white pt-16 pb-0 overflow-hidden font-sans border-t border-white/10 relative">
            {/* Top Content */}
